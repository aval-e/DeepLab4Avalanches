...
class InstSegmentation(LightningModule):
    ...
    def __init__(self, hparams):
        ...
        if hparams.model == 'MaskRCNN':
            self.model = maskrcnn_resnet50_fpn(pretrained=True, num_classes=2, pretrained_backbone=True,
